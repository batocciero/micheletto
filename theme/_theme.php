...
<head>
    ...
    <link rel="icon" href="<?= url("/theme/img/icon.png"); ?>" />
    ...
    <a class="navbar-brand d-block d-lg-none" style="font-weight: 500;" href="#"><?= $mobile; ?></a>
        ...
        <div class="collapse navbar-collapse text-black-50" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
                ...
                <li id="lquiosque" class="nav-item ">
                    <a onclick="addClass('lquiosque')" class="font-weight-bold nav-link " href="<?= url("quiosque"); ?>" tabindex="-1" aria-disabled="true">Quiosque</a>
                </li>
