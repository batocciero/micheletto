...
<div class="home">
    ...
    <div class="title">
        <div class="container p-0">
            <div class="row justify-content-center title">
                ...
                <div class="col-2 p-0 m-0 text-center title-text align-items-center mb-2">Chato pra caralho </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-3">
                <img class="img-fluid" src="<?= url("theme/img/home/home-img1.png"); ?>" alt="Vinhos Micheletto Contato e Endereço Vinhos Louveira">
            </div>
            <div class="col-md-3">
