...
<div id="mudasdeuvas">
    ...
    <div class="container text-center">
        <p class="m-0 p-0 text-justify">
            Criada em 2003 com o propósito da produção de mudas clonadas de videira obtidas de material vegetal com garantia
            de pureza genética e sanitária, a Vitácea Brasil é hoje o viveiro vitícola líder no mercado nacional. Com uma grande
            gama de cepas de variedades e porta-enxertos está presente em todas as regiões vitícolas brasileiras, fornecendo
            mudas de qualidade em todos os segmentos da viticultura: uva de mesa, suco, vinho comum e vinho fino.
        </p>

        <img class="img-fluid" src="<?= url("theme/img/produtos/mudasdeuvas/vitacea.png"); ?>" alt="Vinhos Micheletto">

        <p class="m-0 p-0">
            Desde uma parceria firmada em 2008 a Vinícola Micheletto é a representante comercial da Vitácea Brasil na região de
        ...
        <p class="m-0 p-0 text-justify mt-3 mb-5 pb-3">
            ...
            utilizado é o mesmo das mudas comerciais, ou seja, procedentes do viveiro vitícola Vitacea Brasil.
        </p>
    </div>
</div>
